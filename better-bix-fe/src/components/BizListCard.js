    ...
    return(
        <div style={{margin: '20px 6%', display: 'flex', alignItems: 'center', flexDirection: 'column'}}>
            <div style={{height: '350px', display: 'flex', flexDirection: 'column', backgroundColor: '#423ABA', color: 'white', padding: '20px 10px', width: '300px', justifyContent: 'space-around'}}>
                ...
                <button style={{ fontWeight: '600', boxShadow: '7px 10px 9px rgba(0, 0, 0, 0.25)', margin: '10px 10%', fontSize: '1.2rem', border: 'none', borderRadius: '5px', backgroundColor: 'white', color: '#423ABA', padding: '20px 10px'}}onClick={(e) => props.updateBizPush(props.biz.id, e)} >UPDATE BIZ</button>
                <button style={{ fontWeight: '600', boxShadow: '7px 10px 9px rgba(0, 0, 0, 0.25)', margin: '10px 10%', fontSize: '1.2rem', border: 'none', borderRadius: '5px', backgroundColor: 'white', color: '#423ABA', padding: '20px 10px'}} onClick={(e) => props.viewStats(props.biz.id, e)} >VIEW STATS</button>
